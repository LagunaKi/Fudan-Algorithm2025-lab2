...
def main():
    ...
    parser.add_argument('--max_gap', type=int, default=49, help='gap区间最大合并距离')
    ...
    parser.add_argument('--bonus', type=float, default=21.98, help='顺滑延申奖励')
    parser.add_argument('--slope_eps', type=float, default=0.32, help='主链合并斜率偏差阈值')
    parser.add_argument('--min_k', type=int, default=9, help='最小kmer长度')
    parser.add_argument('--k_ratio', type=float, default=0.68, help='kmer递减比例')
    parser.add_argument('--ex_max_edit_ratio', type=float, default=0.13, help='主链区间延伸允许的最大edit distance比例')
